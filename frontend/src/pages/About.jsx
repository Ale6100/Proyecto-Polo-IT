    ...
    return (
        <section className='section__about-container'>
            ...
            <div className='about__info'>
                En nuestra plataforma web, brindamos asistencia para descubrir la empresa que mejor satisfaga tus necesidades o simplemente para conocer más sobre sus servicios, independientemente del sector. Contamos con un avanzado sistema de filtros que nos permite refinar la búsqueda y ofrecerte opciones que se alineen perfectamente con lo que estás buscando.
            </div>
            <div className='about__valores'>
                <div>
                    <h2 className='subtitle__about'>Nuestro compromiso</h2>
                    <p>Nos comprometemos a simplificar el proceso de selección de empresas, garantizando que encuentres la solución que se ajuste a tus expectativas y requerimientos.</p>
                </div>
            ...
            <div className='about__services'>
                ...
                <div>
                    ...
                    <p> Ya sea que estés buscando servicios en tecnología, salud, finanzas consultorias u otros sectores, nuestros filtros te permitirán explorar una gran variedad de opciones</p>
